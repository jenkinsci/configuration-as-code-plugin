...
Since JCasC version v1.42 we added additional support variable substitution
...
- `${fileBase64:/secret/certificate.p12}` into a base64 representation of the binary file.
