...
For more details, see the link:https://www.jenkins.io/security/advisory/2019-07-31/#SECURITY-1446[Jenkins Security Advisory for SECURITY-1446 (CVE-2019-10362)].
