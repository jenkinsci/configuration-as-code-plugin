...
public class ConfigurationAsCodeTest {
    ...
    public void init_test_from_accepted_sources() throws Exception {
        ...
        Path ftarget = Paths.get("jenkins_folder2.yaml");
        Path fnewLink = Paths.get(tempFolder.getRoot().getAbsolutePath(), "symbolic_link_to_jenkins_folder2.yaml");
        Files.createSymbolicLink(fnewLink, ftarget);

        // symbolic link inside folder pointed to by symbolic link
